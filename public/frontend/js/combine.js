...
jQuery(window).on("load", function() {
    ...
    jQuery(".switch-btn").on("click", function() {
        ...
        return jQuery(".skin").attr("href", "css/skin/skin-2.css"), jQuery(".logo-header img").attr("src", "images/logo2.png"), !1
    }), jQuery(".skin-3").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-3.css"), jQuery(".logo-header img").attr("src", "images/logo3.png"), !1
    }), jQuery(".skin-4").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-4.css"), jQuery(".logo-header img").attr("src", "images/logo4.png"), !1
    }), jQuery(".skin-5").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-5.css"), jQuery(".logo-header img").attr("src", "images/logo5.png"), !1
    }), jQuery(".skin-6").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-6.css"), jQuery(".logo-header img").attr("src", "images/logo6.png"), !1
    }), jQuery(".skin-7").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-7.css"), jQuery(".logo-header img").attr("src", "images/logo7.png"), !1
    }), jQuery(".skin-8").on("click", function() {
        return jQuery(".skin").attr("href", "css/skin/skin-8.css"), jQuery(".logo-header img").attr("src", "images/logo8.png"), !1
