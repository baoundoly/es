...
<body>
    <div class="container">
        <div class="card card-container">
            ...
            <br>
            <form class="form-signin" id="form-signin" action="{{ route('member.reset.password.post') }}" method="post">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    <input type="password" class="form-control" name="password" id="password" value="" placeholder="Enter New Password">
                </div>
                <div class="form-group">
                    <input type="password" class="form-control" name="password_confirmation" id="password_confirmation" value="" placeholder="Enter Confirm New Password">
                </div>
                <div class="row">
    ...
    <script type="text/javascript">
        $(document).ready(function(){       
            $('#form-signin').validate({
                ...
                messages : {
                    'password' : {
                        required : 'The Password must be a required.'
                    },
                    'password_confirmation' : {
                        required : 'The Confirm Password must be a required.',
